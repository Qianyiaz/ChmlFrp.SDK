...
public class NodeData
{
    ...
    public string ChinaString { get; set; } = null!;
    ...
    public string WebString { get; set; } = null!;
    ...
    public string SupportsUdpString { get; set; } = null!;
    ...
    public string HasDefenseString { get; set; } = null!;
